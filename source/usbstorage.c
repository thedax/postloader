...
s32 USBStorage2_ReadSectors(u32 port, u32 sector, u32 numSectors, void *buffer)
	...
	if (!mem2_ptr)
		mem2_ptr = (u8 *) SYS_AllocArena2MemLo(MAX_SECTOR_SIZE * MAX_BUFFER_SECTORS, 32);
...
static inline bool __usbstorage_ReadSectors2(u32 sector, u32 numSectors, void *buffer)
{
	return (USBStorage2_ReadSectors(1, sector, numSectors, buffer) >= 0);
}

static inline bool __usbstorage_WriteSectors2(u32 sector, u32 numSectors, const void *buffer)
{
